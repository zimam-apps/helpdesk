...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.buttonClasses = 'btn btn-xs my-1';
        // this.applyClass = 'btn-success';
        this.applyClass = 'badge-blue';
            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<button class="applyBtn rounded-pill" disabled="disabled" type="button"></button><br> ' +
                        '<button class="cancelBtn rounded-pill" type="button"></button>' +
                    '</div>' +
                '</div>' +
            '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        formInputsBlurred: function(e) {
            ...
            // this function has one site right now: if you tab from the first
