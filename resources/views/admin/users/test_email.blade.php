<form class="px-3 needs-validation" method="post" action="{{ route('admin.test.email.send') }}" id="test_email" novalidate>
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-2 text-end">
            ...
            <button class="btn-create btn btn-primary" type="submit">{{ __('Send Test Mail') }}</button>
        </div>
    </div>
</form>
