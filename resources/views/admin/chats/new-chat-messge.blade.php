                    ...
                    <div class="msg right-msg">
                        <div class="msg-box">
                            <div class="msg-box-content">
                                ...
                                <span>
                                    {{ \Carbon\Carbon::parse($ticket->created_at)->timezone('Asia/Riyadh')->locale('ar')->translatedFormat('l h:ia') }}
                                </span>
                            </div>
                            ...
                            <div class="msg-box {{ isset($isSaveChat, $conversion->is_bookmark) && $isSaveChat && $conversion->is_bookmark ? 'bookmark-active' : '' }}"
                                ...
                                <div class="msg-box-content">
                                    <div class="msg-box-inner">
                                      ...
                                      <span>
                                    {{ \Carbon\Carbon::parse($conversion->created_at)->timezone('Asia/Riyadh')->locale('ar')->translatedFormat('l h:ia') }}
                                </span>
                                    {{-- save chat addon --}}
                                    @stack('save-chat')
                                    {{-- end --}}
                            ...
                            <li>
                                <a href="javascript:void;" data-size="md" class="footer-btn"
                                    ...
                                    <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M17.5579 8.83959L18.9725 6.04805C19.1218 5.75348 19.0649 5.39906 18.831 5.16614C18.598 4.9342 18.2451 4.87912 17.9528 5.02884L15.1806 6.4492L12.9801 4.23661C12.748 4.00326 12.3951 3.94645 12.1019 4.09528C11.8077 4.24458 11.6445 4.56412 11.696 4.89047L12.1833 7.98469L9.40852 9.40631C9.11569 9.55636 8.95378 9.87586 9.00553 10.2014C9.05723 10.5264 9.30998 10.7795 9.63441 10.8312L10.9734 11.0445L0.412172 21.6002C0.146391 21.8658 0 22.2189 0 22.5946C0 22.9702 0.146391 23.3234 0.412172 23.589C0.686391 23.8631 1.04648 24 1.40672 24C1.76686 24 2.12709 23.863 2.40127 23.589L7.97011 18.0235C8.15325 17.8405 8.15334 17.5437 7.97034 17.3606C7.78734 17.1774 7.49058 17.1773 7.30744 17.3604L1.73859 22.9259C1.55564 23.1088 1.25784 23.1087 1.07489 22.9259C0.986297 22.8373 0.9375 22.7197 0.9375 22.5945C0.9375 22.4694 0.986297 22.3518 1.07489 22.2633L12.1174 11.2266L12.7088 11.3208L12.7961 11.875L9.95995 14.7095C9.77681 14.8925 9.77672 15.1893 9.95972 15.3724C10.0513 15.464 10.1713 15.5098 10.2913 15.5098C10.4112 15.5098 10.5311 15.4641 10.6226 15.3726L12.9765 13.0201L13.1961 14.4139C13.2474 14.7401 13.5006 14.9938 13.8262 15.0451C13.866 15.0514 13.9057 15.0545 13.9451 15.0545C14.2268 15.0545 14.4882 14.8972 14.619 14.6392L16.0323 11.85L19.1056 12.3395C19.4298 12.3908 19.7483 12.2291 19.8982 11.9364C20.0484 11.6427 19.9932 11.2883 19.7607 11.0546L17.5579 8.83959ZM16.0492 10.9035C15.7238 10.8517 15.4047 11.0147 15.2554 11.3093L14.0354 13.717L13.6147 11.0467C13.5634 10.7211 13.3107 10.4675 12.9856 10.4157L10.3225 9.99159L12.7262 8.76014C13.0186 8.61033 13.1806 8.2913 13.1295 7.96626L12.7084 5.29298L14.6091 7.20412C14.8421 7.43845 15.196 7.49466 15.49 7.34414L17.8871 6.11601L16.6636 8.53041C16.5151 8.82342 16.5709 9.17667 16.8024 9.40955L18.7096 11.3272L16.0492 10.9035Z"
                                                fill="#555555" />
                                            <path
                                                d="M22.0948 1.88629C21.9113 1.70376 21.6145 1.70446 21.4319 1.88807L19.8005 3.52837C19.6179 3.71193 19.6187 4.0087 19.8023 4.19132C19.8937 4.28221 20.0133 4.32768 20.1328 4.32768C20.2532 4.32768 20.3736 4.2816 20.4652 4.18949L22.0966 2.5492C22.2791 2.36568 22.2784 2.06887 22.0948 1.88629Z"
                                                fill="#555555" />
                                            <path
                                                d="M16.1191 2.30313C16.1437 2.30702 16.1683 2.3089 16.1926 2.3089C16.4192 2.3089 16.6186 2.14404 16.655 1.91304L16.8354 0.767462C16.8757 0.511759 16.7011 0.271806 16.4454 0.231493C16.1901 0.191181 15.9497 0.365837 15.9094 0.621634L15.7289 1.76721C15.6887 2.02292 15.8633 2.26287 16.1191 2.30313Z"
                                                fill="#555555" />
                                            <path
                                                d="M10.8447 2.74772C10.9273 2.91075 11.0921 3.00469 11.2632 3.00469C11.3345 3.00469 11.4068 2.98837 11.4748 2.95397C11.7057 2.83697 11.798 2.55487 11.681 2.32392L10.6335 0.256967C10.5165 0.0260137 10.2345 -0.0662832 10.0035 0.0507168C9.77258 0.167717 9.68028 0.449811 9.79733 0.680764L10.8447 2.74772Z"
                                                fill="#555555" />
                                            <path
                                                d="M7.45485 5.57104L8.48268 6.09763C8.55111 6.13265 8.6241 6.14929 8.69605 6.14929C8.86635 6.14929 9.03065 6.05619 9.11361 5.89419C9.23165 5.6638 9.14052 5.38129 8.91013 5.26326L7.8823 4.73666C7.65191 4.61877 7.36944 4.70966 7.25136 4.94015C7.13333 5.17049 7.22441 5.45296 7.45485 5.57104Z"
                                                fill="#555555" />
                                            <path
                                                d="M18.7395 15.1464C18.6224 14.9154 18.3405 14.8231 18.1095 14.9401C17.8785 15.0571 17.7862 15.3392 17.9033 15.5702L18.427 16.6037C18.5097 16.7667 18.6744 16.8607 18.8455 16.8607C18.9168 16.8607 18.9891 16.8443 19.0571 16.8099C19.288 16.6929 19.3803 16.4108 19.2633 16.1799L18.7395 15.1464Z"
                                                fill="#555555" />
                                            <path
                                                d="M23.745 13.4569L21.6894 12.4038C21.4591 12.2859 21.1766 12.3768 21.0585 12.6073C20.9405 12.8377 21.0316 13.1202 21.262 13.2382L23.3176 14.2914C23.386 14.3264 23.459 14.343 23.531 14.343C23.7013 14.343 23.8655 14.2499 23.9485 14.0879C24.0665 13.8575 23.9754 13.575 23.745 13.4569Z"
                                                fill="#555555" />
                                            <path
                                                d="M21.6778 7.8952C21.7145 8.12587 21.9137 8.29031 22.1401 8.29031C22.1646 8.29031 22.1895 8.28834 22.2144 8.2844L23.3538 8.10295C23.6094 8.06221 23.7837 7.82193 23.743 7.56623C23.7023 7.31057 23.4617 7.1369 23.2063 7.17703L22.067 7.35848C21.8113 7.39926 21.6371 7.63954 21.6778 7.8952Z"
                                                fill="#555555" />
                                            <path
                                                d="M9.42557 16.3806C9.4354 16.122 9.23372 15.9043 8.9751 15.8945C8.71647 15.8846 8.49884 16.0863 8.489 16.345C8.47917 16.6036 8.68085 16.8212 8.93947 16.831C9.1981 16.8409 9.41573 16.6392 9.42557 16.3806Z"
                                                fill="#555555" />
                                        </svg>
                                    </span>
                                </a>
        ...
        <div class="msg-card-top d-flex align-items-center justify-content-between gap-2">
            <div class="info-name-wrp d-flex align-items-center gap-2 flex-warp flex-1">
                <div class="avatar-image">
                    <img class="avatar-sm rounded-circle mr-3" alt="{{ $ticket->name }}"
                        avatar="{{ $ticket->name }}">
                </div>
                <div class="info-name">
            ...
            <button type="button" class="btn btn-primary close-icon">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M0.301791 13.2446C-0.0997985 13.6463 -0.0997366 14.2973 0.301914 14.6988C0.703565 15.1004 1.3547 15.1004 1.75628 14.6987L7.50013 8.95434L13.2444 14.6982C13.646 15.0998 14.2972 15.0998 14.6988 14.6982C15.1004 14.2967 15.1004 13.6455 14.6988 13.244L8.95439 7.49998L14.6984 1.75539C15.0999 1.35377 15.0999 0.70268 14.6982 0.301131C14.2966 -0.100428 13.6454 -0.100367 13.2438 0.301254L7.49992 6.04573L1.75558 0.301748C1.35397 -0.0998319 0.702825 -0.0998319 0.301215 0.301748C-0.100405 0.703338 -0.100405 1.35443 0.301215 1.75602L6.04577 7.50009L0.301791 13.2446Z"
                        fill="white" />
                </svg>
            </button>
        </div>
                    ...
                    <div class="" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <a href="#" id="save-subject">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M17.4425 2.88241H15.4522V1.99201C15.4522 1.70394 15.1379 1.57301 14.8498 1.57301H13.3047C12.9381 0.525466 12.0215 0.00169566 10.974 0.00169566C9.93796 -0.0372525 8.99564 0.597998 8.6432 1.57301H7.12427C6.8362 1.57301 6.54812 1.70394 6.54812 1.99201V2.88241H4.55775C3.37828 2.89499 2.41335 3.82543 2.35791 5.00365V20.0096C2.35791 21.1619 3.40545 21.9999 4.55775 21.9999H17.4425C18.5948 21.9999 19.6423 21.1619 19.6423 20.0096V5.0037C19.5869 3.82543 18.622 2.89499 17.4425 2.88241ZM7.59561 2.62055H9.03599C9.28742 2.58987 9.48938 2.39859 9.5336 2.14916C9.68869 1.47376 10.2812 0.988934 10.974 0.970688C11.6603 0.99149 12.2439 1.47782 12.3881 2.14916C12.4351 2.40721 12.6504 2.60095 12.9119 2.62055H14.4047V4.71562H7.59561V2.62055ZM18.5948 20.0097C18.5948 20.5858 18.0186 20.9524 17.4425 20.9524H4.55775C3.9816 20.9524 3.40545 20.5858 3.40545 20.0097V5.0037C3.45888 4.40399 3.95574 3.94097 4.55775 3.92999H6.54807V5.26561C6.57574 5.55905 6.82988 5.77855 7.12422 5.76321H14.8498C15.1495 5.77961 15.4117 5.56311 15.4521 5.26561V3.92994H17.4424C18.0444 3.94097 18.5413 4.40394 18.5947 5.00365V20.0097H18.5948Z"
                                    fill="#888888" />
                                <path
                                    d="M8.98383 11.708C8.78739 11.5009 8.46127 11.4892 8.25053 11.6818L6.57446 13.2793L5.86738 12.546C5.67093 12.3389 5.34481 12.3273 5.13408 12.5198C4.93122 12.7324 4.93122 13.0667 5.13408 13.2793L6.20779 14.3792C6.30072 14.4833 6.43496 14.5408 6.57441 14.5363C6.71256 14.5344 6.84434 14.4779 6.94103 14.3792L8.98373 12.4413C9.18624 12.2555 9.19978 11.9407 9.01396 11.7382C9.00443 11.7277 8.99436 11.7176 8.98383 11.708Z"
                                    fill="#888888" />
                                <path
                                    d="M16.4997 12.834H10.4764C10.1871 12.834 9.95264 13.0685 9.95264 13.3578C9.95264 13.647 10.1871 13.8815 10.4764 13.8815H16.4997C16.789 13.8815 17.0235 13.647 17.0235 13.3578C17.0235 13.0685 16.789 12.834 16.4997 12.834Z"
                                    fill="#888888" />
                                <path
                                    d="M8.98383 7.51778C8.78739 7.31071 8.46127 7.29903 8.25053 7.49162L6.57446 9.08909L5.86738 8.3558C5.67093 8.14872 5.34481 8.13704 5.13408 8.32963C4.93122 8.54216 4.93122 8.87656 5.13408 9.08909L6.20779 10.189C6.30072 10.2931 6.43496 10.3506 6.57441 10.3462C6.71256 10.3442 6.84434 10.2877 6.94103 10.189L8.98373 8.25108C9.18624 8.06531 9.19978 7.75052 9.01396 7.54806C9.00443 7.53748 8.99436 7.52741 8.98383 7.51778Z"
                                    fill="#888888" />
                                <path
                                    d="M16.4997 8.64392H10.4764C10.1871 8.64392 9.95264 8.87841 9.95264 9.16769C9.95264 9.45697 10.1871 9.69146 10.4764 9.69146H16.4997C16.789 9.69146 17.0235 9.45697 17.0235 9.16769C17.0235 8.87841 16.789 8.64392 16.4997 8.64392Z"
                                    fill="#888888" />
                                <path
                                    d="M8.98383 15.898C8.78739 15.6909 8.46127 15.6793 8.25053 15.8718L6.57446 17.4693L5.86738 16.736C5.67093 16.529 5.34481 16.5173 5.13408 16.7099C4.93122 16.9224 4.93122 17.2568 5.13408 17.4693L6.20779 18.5692C6.30072 18.6733 6.43496 18.7309 6.57441 18.7264C6.71256 18.7244 6.84434 18.6679 6.94103 18.5692L8.98373 16.6313C9.18624 16.4455 9.19978 16.1307 9.01396 15.9283C9.00443 15.9178 8.99436 15.9077 8.98383 15.898Z"
                                    fill="#888888" />
                                <path
                                    d="M16.4997 17.0242H10.4764C10.1871 17.0242 9.95264 17.2587 9.95264 17.5479C9.95264 17.8372 10.1871 18.0717 10.4764 18.0717H16.4997C16.789 18.0717 17.0235 17.8372 17.0235 17.5479C17.0235 17.2587 16.789 17.0242 16.4997 17.0242Z"
                                    fill="#888888" />
                            </svg>
                        </a>
                    </div>
            ...
            <ul class="tag-wrp mb-0">
                @if (count($customFields) > 0)
                    <li class="d-flex align-items-center gap-2 justify-content-between">
                        ...
                        <a href="#" title="{{ __('View Custom Field') }}" data-ajax-popup="true"
                ...
                <li class="d-flex align-items-center gap-2 justify-content-between">
                    ...
                    <a href="#" title="{{ __('Private Note') }}" data-ajax-popup="true"
