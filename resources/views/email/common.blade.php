                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width:110px;">
                                                                                    <img alt="" height="auto" src="{{ getFile(getSidebarLogo()) }}{{ '?' . time() }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="110"/>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
